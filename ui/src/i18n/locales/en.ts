...
export const en: TranslationMap = {
  ...
  tabs: {
    ...
    nodes: "Nodes",
    chat: "Chat",
    "niche-programs": "Programs",
    "niche-benchmarks": "Benchmarks",
    "niche-runtime": "Runtime",
    config: "Config",
    debug: "Debug",
    logs: "Logs",
  },
  subtitles: {
    ...
    "niche-programs": "Compiled niche programs and their risk classes.",
    "niche-benchmarks": "Benchmark records, suites, and accuracy deltas.",
    "niche-runtime": "Active stacks, agent defaults, and route overlays.",
